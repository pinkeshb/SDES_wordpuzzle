...
class ExamplePanel(wx.Panel):
    ...
    def __init__(self, parent, app):
        ...
        self.grid_size = 12
        self.app = app
        self.quote = wx.StaticText(self, label="Hi !! You have to find a set of english words embedded in n by n matrix of characters.", pos=(
            20, 30), size=(375, 300), style=wx.TE_MULTILINE | wx.TE_READONLY)
        # A button
        ...
        self.lblhear = wx.StaticText(
            self, label="Choose the Topic", pos=(20, 90))
        self.edithear = wx.ComboBox(self, pos=(20, 120), size=(
            150, -1), choices=self.sampleList, style=wx.CB_DROPDOWN)  # in pos(column,row)
        self.Bind(wx.EVT_COMBOBOX, self.EvtComboBox, self.edithear)
        self.lblhear1 = wx.StaticText(self, label="Grid Size", pos=(20, 170))
        self.edithear1 = wx.ComboBox(self, pos=(20, 200), size=(
            150, -1), choices=['8 x 8', '12 x 12'], style=wx.CB_DROPDOWN)  # in pos(column,row)
